...
CUserInterface::CUserInterface()
{
	...
	TwAddVarRW(mUserInterface, "colorBorder", TW_TYPE_COLOR3F, &mFigureColorBorder[0], "label = 'ColorBorder'");
}
...
void CUserInterface::setFigureColorBorder(float *color)
{
	mFigureColorBorder[0] = color[0];
	mFigureColorBorder[1] = color[1];
	mFigureColorBorder[2] = color[2];
}

float* CUserInterface::getFigureColorBorder()
{
	return mFigureColorBorder;
}